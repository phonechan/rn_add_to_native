...
package com.everonet.demo.miniprograms.zxing.utils;
...
public class CaptureActivityHandler extends Handler {
    ...
    private final MiniScanActivity activity;
    private final DecodeThread decodeThread;
    private final CameraManager cameraManager;
    private State state;

    public CaptureActivityHandler(MiniScanActivity activity, CameraManager cameraManager, int decodeMode) {
